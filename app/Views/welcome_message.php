...
<header>
    ...
    <div class="heroe">
        ...
        <h2>Uji Kompetensi 2</h2>

        <div style="margin-top: 20px;">
            <?php if (logged_in()) : ?>
                <a href="<?= base_url('admin') ?>" style="display:inline-block; background-color: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-right: 10px;">Ke Dashboard (Anda Sedang Login)</a>
                <a href="<?= base_url('admin-logout') ?>" style="display:inline-block; background-color: #dc3545; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Logout</a>
            <?php else : ?>
                <a href="<?= base_url('login') ?>" style="display:inline-block; background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Login Admin</a>
            <?php endif; ?>
        </div>
